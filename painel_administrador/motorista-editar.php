...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div class="table-responsive">
            <h4>
                Editar Motorista
                <a href="tabela-motorista.php" class="btn btn-danger float-end">voltar</a>
            </h4>
            <div class="card-body">
                <?php
                if(isset($_GET['id'])){
                    $motorista_id = mysqli_real_escape_string($conn,$_GET['id']);
                    $sql="SELECT * FROM motorista where id='$motorista_id'";
                    $result=$conn->query($sql);
                    if($result->num_rows>0){
                        $row =$result->fetch_assoc();
                ?>
                <form action="acoes.php" method="POST">
                    <input type="hidden" name="motorista_id" value="<?= $row['id']?>">
                    <div class="mb-3">
                        <label for="">Nome</label>
                        <input type="text" name="Nome" class="form-control"  pattern="^[A-Za-zÀ-ú]+(\s[A-Za-zÀ-ú]+)+$"value="<?= $row['Nome']?>" >
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="Contacto" class="form-control" required pattern="^\d{9}$" value="<?= $row['Contacto']?>">
                    </div>
                    ...
                    <div class="mb-3">
                        <button type="submit" name="actualizar_motorista" class="btn btn-primary">SALVAR</button>
