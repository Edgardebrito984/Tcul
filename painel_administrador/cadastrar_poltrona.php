...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div class="table-responsive">
            <h4>
                Adicionar poltrona
                <a href="tabela-poltrona.php" class="btn btn-danger float-end">voltar</a>
            </h4>
            <div class="card-body">
                <form action="acoes.php" method="POST">
                   <select name="data_viagem_id" class="form-control" id="">
                        <option value="">Selecione a data das poltronas</option>
                        <?php
                        require '../conecao.php';
                         $query= "SELECT id, data_viagem FROM datas_viagens";
                         $result = mysqli_query($conn, $query);
                         while ($row = mysqli_fetch_assoc($result)) {
                             echo "<option value='{$row['id']}'>{$row['data_viagem']}</option>";
                    ...
                    <div class="mb-3">
                        <label for="">Data_Viagens</label>
                     
                    </div>
            
                    <div class="mb-3">
                        <button type="submit" name="criar_poltronas" class="btn btn-primary">SALVAR</button>
