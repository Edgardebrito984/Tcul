    ...
    <div id="wrapper">
        ...
        <div class="table-responsive">
            ...
            <div class="card-body">
                <?php
                if(isset($_GET['id'])){
                    $rota_id = mysqli_real_escape_string($conn,$_GET['id']);
                ...
                <form action="acoes.php" method="POST">
                    <input type="hidden" name="rota" value="<?= $row['id']?>">
                    <div class="mb-3">
                        <label for="">origem</label>
                        <input type="text" name="origem" class="form-control" value="<?= $row['origem']?>" >
                    </div>
               
            
                    <div class="mb-3">
                        <label for="">Destino</label>
                        <input name="destino" class="form-control"  value="<?= $row['destino']?>">
                    </div>
                
                    <div class="mb-3">
                        <label for="">Preço</label>
                        <input name="preco" class="form-control"  value="<?= $row['preco']?>">
                    </div>
                  ...
                  <input type="hidden" name="autocarro_id" value="<?php echo $autocarro_id; ?>">
                    <div class="mb-3">
                        <button type="submit" name="actualizar_rota" class="btn btn-primary">SALVAR</button>
                    </div>
                    </form>
                    <?php
                   }else{
